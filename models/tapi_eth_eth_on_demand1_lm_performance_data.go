...
// TapiEthEthOnDemand1LmPerformanceData tapi eth eth on demand1 lm performance data
...
func (m *TapiEthEthOnDemand1LmPerformanceData) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TapiEthEthOnDemand1LmPerformanceData) UnmarshalBinary(b []byte) error {
	var res TapiEthEthOnDemand1LmPerformanceData
