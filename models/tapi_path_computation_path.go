...
// TapiPathComputationPath tapi path computation path
// swagger:model tapi.path.computation.Path
type TapiPathComputationPath struct {
	...
	// none
	Link []*TapiTopologyLinkRef `json:"link"`
...
func (m *TapiPathComputationPath) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m TapiPathComputationPath) MarshalJSON() ([]byte, error) {
...
// Validate validates this tapi path computation path
func (m *TapiPathComputationPath) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TapiPathComputationPath) validateDirection(formats strfmt.Registry) error {
...
func (m *TapiPathComputationPath) validateLayerProtocolName(formats strfmt.Registry) error {
...
func (m *TapiPathComputationPath) validateLink(formats strfmt.Registry) error {
...
func (m *TapiPathComputationPath) validateRoutingConstraint(formats strfmt.Registry) error {
...
func (m *TapiPathComputationPath) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TapiPathComputationPath) UnmarshalBinary(b []byte) error {
	var res TapiPathComputationPath
