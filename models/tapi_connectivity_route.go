...
// TapiConnectivityRoute tapi connectivity route
// swagger:model tapi.connectivity.Route
...
func (m *TapiConnectivityRoute) UnmarshalJSON(raw []byte) error {
	// AO0
	...
	m.ConnectionEndPoint = dataAO1.ConnectionEndPoint

	return nil
}

// MarshalJSON marshals this object to a JSON structure
func (m TapiConnectivityRoute) MarshalJSON() ([]byte, error) {
	...
	dataAO1.ConnectionEndPoint = m.ConnectionEndPoint
...
// Validate validates this tapi connectivity route
func (m *TapiConnectivityRoute) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TapiConnectivityRoute) validateConnectionEndPoint(formats strfmt.Registry) error {
...
func (m *TapiConnectivityRoute) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TapiConnectivityRoute) UnmarshalBinary(b []byte) error {
	var res TapiConnectivityRoute
