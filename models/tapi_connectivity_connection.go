...
func (m *TapiConnectivityConnection) UnmarshalJSON(raw []byte) error {
	...
	m.SupportedClientLink = dataAO2.SupportedClientLink
...
func (m TapiConnectivityConnection) MarshalJSON() ([]byte, error) {
	...
	dataAO2.SupportedClientLink = m.SupportedClientLink
...
func (m *TapiConnectivityConnection) validateLowerConnection(formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.LowerConnection); i++ {
		...
		if m.LowerConnection[i] != nil {
			if err := m.LowerConnection[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("lower-connection" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *TapiConnectivityConnection) validateSupportedClientLink(formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.SupportedClientLink); i++ {
		...
		if m.SupportedClientLink[i] != nil {
			if err := m.SupportedClientLink[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("supported-client-link" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
