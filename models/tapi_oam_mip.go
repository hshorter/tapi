...
// TapiOamMip tapi oam mip
// swagger:model tapi.oam.Mip
type TapiOamMip struct {
...
func (m *TapiOamMip) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m TapiOamMip) MarshalJSON() ([]byte, error) {
...
// Validate validates this tapi oam mip
func (m *TapiOamMip) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TapiOamMip) validateLayerProtocolName(formats strfmt.Registry) error {
...
func (m *TapiOamMip) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TapiOamMip) UnmarshalBinary(b []byte) error {
	var res TapiOamMip
