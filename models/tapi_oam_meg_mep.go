...
// Validate validates this tapi oam meg mep
...
func (m *TapiOamMegMep) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TapiOamMegMep) UnmarshalBinary(b []byte) error {
	var res TapiOamMegMep
