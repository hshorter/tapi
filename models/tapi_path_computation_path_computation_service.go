...
func (m *TapiPathComputationPathComputationService) UnmarshalJSON(raw []byte) error {
	...
	m.TopologyConstraint = dataAO1.TopologyConstraint
...
func (m TapiPathComputationPathComputationService) MarshalJSON() ([]byte, error) {
	...
	dataAO1.TopologyConstraint = m.TopologyConstraint
...
func (m *TapiPathComputationPathComputationService) validateTopologyConstraint(formats strfmt.Registry) error {
