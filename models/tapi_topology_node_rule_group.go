...
func (m *TapiTopologyNodeRuleGroup) UnmarshalJSON(raw []byte) error {
	...
	m.ComposedRuleGroup = dataAO5.ComposedRuleGroup
...
func (m TapiTopologyNodeRuleGroup) MarshalJSON() ([]byte, error) {
	...
	dataAO5.ComposedRuleGroup = m.ComposedRuleGroup
...
func (m *TapiTopologyNodeRuleGroup) validateComposedRuleGroup(formats strfmt.Registry) error {
...
func (m *TapiTopologyNodeRuleGroup) validateNodeEdgePoint(formats strfmt.Registry) error {
