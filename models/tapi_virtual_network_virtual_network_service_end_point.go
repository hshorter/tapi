...
// TapiVirtualNetworkVirtualNetworkServiceEndPoint tapi virtual network virtual network service end point
// swagger:model tapi.virtual.network.VirtualNetworkServiceEndPoint
type TapiVirtualNetworkVirtualNetworkServiceEndPoint struct {
...
func (m *TapiVirtualNetworkVirtualNetworkServiceEndPoint) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m TapiVirtualNetworkVirtualNetworkServiceEndPoint) MarshalJSON() ([]byte, error) {
...
// Validate validates this tapi virtual network virtual network service end point
func (m *TapiVirtualNetworkVirtualNetworkServiceEndPoint) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TapiVirtualNetworkVirtualNetworkServiceEndPoint) validateDirection(formats strfmt.Registry) error {
...
func (m *TapiVirtualNetworkVirtualNetworkServiceEndPoint) validateRole(formats strfmt.Registry) error {
...
func (m *TapiVirtualNetworkVirtualNetworkServiceEndPoint) validateServiceInterfacePoint(formats strfmt.Registry) error {
...
func (m *TapiVirtualNetworkVirtualNetworkServiceEndPoint) validateServiceLayer(formats strfmt.Registry) error {
...
func (m *TapiVirtualNetworkVirtualNetworkServiceEndPoint) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TapiVirtualNetworkVirtualNetworkServiceEndPoint) UnmarshalBinary(b []byte) error {
	var res TapiVirtualNetworkVirtualNetworkServiceEndPoint
