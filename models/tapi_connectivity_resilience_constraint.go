...
func (m *TapiConnectivityResilienceConstraint) validatePreferredRestorationLayer(formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.PreferredRestorationLayer); i++ {
		...
		if err := m.PreferredRestorationLayer[i].Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("preferred-restoration-layer" + "." + strconv.Itoa(i))
			}
			return err
		}
